...
public class MonitoredEndpointControllerUpdateMonitoredEndpointTest extends IntegrationTestParent {
    ...
    public void shouldUpdateMonitoredEndpoint_WithValidRequest() {
        ...
        MatcherAssert.assertThat(monitoredEndpoint.getId(), Is.is(MONITORED_ENDPOINT_ID.toString()));
